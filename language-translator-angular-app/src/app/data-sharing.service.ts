...
// targetUdi: string Observable // what user has requested
private targetAge18PlusSubject = new BehaviorSubject<any>(null);
public targetAge18Plus = this.targetAge18PlusSubject.asObservable();
setAgeVerificationResponse(s: string) {
  console.log("Data-Sharing-Svc stored targetAge18Plus: ", s);
  this.targetAge18PlusSubject.next(s);
}
